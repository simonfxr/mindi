 ...
 * using the pure Kotlin API instead of reflection and annotations.
 *
 * This is the multiplatform equivalent of the JVM-specific ParentChildPrimaryTest.
 *
 * Key test cases:
 ...
 */
class ParentChildPrimaryApiTest {
    ...
    fun testChildNonPrimaryTakesPrecedenceOverParentPrimary() {
        ...
        try {
            ...
            val childConsumer = Component { -> ChildServiceConsumer() }
    ...
    fun testParentContextUsesParentPrimary() {
        ...
        val parentConsumer = Component { -> ParentServiceConsumer() }
            .setting(required = true) { it: TestService -> this.service = it }
    ...
    fun testQualifiedComponentsAcrossContexts() {
        ...
        val primaryParentService = Component { -> ParentPrimaryService() }
            .withSuperType<_, TestService>()
            .with(primary = true)
            .named("parentService")
        ...
        try {
            ...
            val qualifiedConsumer = Component { -> QualifiedParentConsumer() }
                .setting(qualifier = "nonPrimary", required = true) { it: TestService -> this.service = it }
    ...
    fun testAmbiguityWithMultipleNonPrimaryComponents() {
        ...
        try {
            ...
            val childService1 = Component { -> ChildNonPrimaryService() }
                .withSuperType<_, TestService>()
                .named("childService1")

            val childService2 = Component { -> SecondChildNonPrimaryService() }
                .withSuperType<_, TestService>()
                .named("childService2")

            val childServiceConsumer = Component { -> ChildServiceConsumer() }
                .setting(required = true) { it: TestService -> this.service = it }
                .named("childServiceConsumer")
    ...
    fun testPrimaryComponentChosenFromMultipleComponents() {
        ...
        val parentPrimaryService = Component { -> ParentPrimaryService() }
            .withSuperType<_, TestService>()
            .with(primary = true)
            .named("parentPrimaryService")

        val parentNonPrimaryService = Component { -> ParentNonPrimaryService() }
            .withSuperType<_, TestService>()
            .named("parentNonPrimaryService")
        ...
        try {
            ...
            val childPrimaryService = Component { -> ChildPrimaryService() }
                .withSuperType<_, TestService>()
                .with(primary = true)
                .named("childPrimaryService")

            val childNonPrimaryService = Component { -> ChildNonPrimaryService() }
                .withSuperType<_, TestService>()
                .named("childNonPrimaryService")
